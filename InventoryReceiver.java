...
public class InventoryReceiver extends GUI{
    ...
    public InventoryReceiver(String invName) throws IOException
    {
        //build GUI;
        super (invName);
        bHandler = new ButtonHandler ();
        cHandler = new CuttonHandler ();
        sendButton.addActionListener (bHandler);
        connectButton.addActionListener (cHandler);

        inputPort.setText(Integer.toString(4466));
    ...
    public PrivateKey decodePrivateKey(byte[] privateKeyBytes){
        try {
    ...
    public PublicKey decodePublicKey(byte[] publicKeyBytes){
        try {
    ...
    public static void main(String[] args){
        try {
            InventoryReceiver inv = new InventoryReceiver("Inventory Receiver");
